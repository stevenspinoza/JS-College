...
const v1Markets = require('./routes/api/v1/markets');
const v1Shapes = require('./routes/api/v1/shapes');

// Define Routes
app.use('/api/v1/contacts', v1Contacts);
app.use('/api/v1/fruits', v1Fruits);
app.use('/api/v1/markets', v1Markets);
app.use('/api/v1/shapes', v1Shapes);
